    ...
    <header class="header">
        <div class="header-left">
            <div class="logo">
                ...
                <span class="version-badge" data-version="standard" style="
                    display: inline-flex;
                    align-items: center;
                    padding: 3px 8px;
                    margin-left: 12px;
    ...
    <nav class="sidebar" id="sidebar">
        <div class="menu">
            ...
            <div class="menu-item-group">
                ...
                <div class="submenu">
                    <a href="javascript:void(0)" class="menu-item submenu-item disabled" style="opacity: 0.4; cursor: not-allowed; pointer-events: none;">
                        <span style="font-size: 16px; margin-right: 10px;">📈</span>
